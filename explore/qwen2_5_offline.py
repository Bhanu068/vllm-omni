...
def main(args):
    ...
    llm = OmniLLM(model="Qwen/Qwen2.5-Omni-3B", stage_configs_path="explore/qwen2_5_omni_rtx4090.yaml")
    outputs = llm.generate(prompts="Convert this text into speech - 'Hello'", sampling_params_list=[SamplingParams()])
    print(outputs)
...
def parse_args():
    ...
    parser.add_argument(
        ...
        "-m",
        type=str,
        default="Qwen/Qwen2.5-Omni-7B-AWQ",
        help="Model name or path (default: Qwen/Qwen2.5-Omni-7B-AWQ).",
    )
